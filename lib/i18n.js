...
const dict = {
  en: {
    ...
    syncSynced: '☁ Synced',
    syncSaving: '☁ Saving…',
    syncOffline: '☁ Offline (this device only)',
    syncError: '☁ Sync error — saved on this device',

    // ---- unlock (passcode gate) ----
    unlockTitle: 'Private access',
    unlockSub: 'Enter your passcode to open the screener.',
    unlockPlaceholder: 'Passcode',
    unlockButton: 'Unlock',
    unlockChecking: 'Checking…',
    unlockWrong: 'Wrong passcode. Try again.',
  ...
  bg: {
    ...
    // ---- sync status ----
    syncSynced: '☁ Синхронизирано',
    syncSaving: '☁ Записвам…',
    syncOffline: '☁ Офлайн (само това устройство)',
    syncError: '☁ Грешка при синхр. — запазено на това устройство',

    // ---- unlock (passcode gate) ----
    unlockTitle: 'Частен достъп',
    unlockSub: 'Въведи своя passcode, за да отвориш скенера.',
    unlockPlaceholder: 'Passcode',
    unlockButton: 'Отключи',
    unlockChecking: 'Проверявам…',
    unlockWrong: 'Грешен passcode. Опитай пак.',
    unlockError: 'Нещо се обърка. Опитай пак.',
  },
};
